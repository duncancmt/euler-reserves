...
interface IMarkets {
  ...
  function underlyingToDToken(address) external view returns (IDToken);
}
...
abstract contract Common is Script {
  ...
  address[] internal _UNDERLYINGS = [
    ...
    0x53BcCB38A174aDCa09D5103D561D1cB99BFe97af,
    ...
    0x53a0340ED6BA1Fd460608e2CD0424A339B56D3E2,
